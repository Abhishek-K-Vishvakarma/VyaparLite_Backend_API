...
import { downloadInvoice, generatePDF, sendInvoiceByEmail, sendInvoiceByWhatsApp, getInvoiceList } from "../controllers/invoice.controller.js";
...
router.get("/invoice-list", protect, getInvoiceList);
